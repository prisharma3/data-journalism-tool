...
export interface Insight {
  ...
  isAIGenerated?: boolean; // Whether this was generated by AI
  aiGeneratedContent?: string; // Original AI-generated content (preserved even if user edits)
  status?: 'pending' | 'accepted' | 'edited' | 'rejected'; // Workflow status
}
